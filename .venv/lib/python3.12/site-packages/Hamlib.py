...
RIG_MODEL_GQRX = _Hamlib.RIG_MODEL_GQRX
...
RIG_MODEL_FTX1 = _Hamlib.RIG_MODEL_FTX1
...
RIG_MODEL_SDRCONSOLE = _Hamlib.RIG_MODEL_SDRCONSOLE
RIG_MODEL_QRPLABS_QMX = _Hamlib.RIG_MODEL_QRPLABS_QMX
...
RIG_MODEL_X6200 = _Hamlib.RIG_MODEL_X6200
RIG_MODEL_IC7760 = _Hamlib.RIG_MODEL_IC7760
...
RIG_MODEL_SMARTSDR_A = _Hamlib.RIG_MODEL_SMARTSDR_A
RIG_MODEL_SMARTSDR_B = _Hamlib.RIG_MODEL_SMARTSDR_B
RIG_MODEL_SMARTSDR_C = _Hamlib.RIG_MODEL_SMARTSDR_C
RIG_MODEL_SMARTSDR_D = _Hamlib.RIG_MODEL_SMARTSDR_D
RIG_MODEL_SMARTSDR_E = _Hamlib.RIG_MODEL_SMARTSDR_E
RIG_MODEL_SMARTSDR_F = _Hamlib.RIG_MODEL_SMARTSDR_F
RIG_MODEL_SMARTSDR_G = _Hamlib.RIG_MODEL_SMARTSDR_G
RIG_MODEL_SMARTSDR_H = _Hamlib.RIG_MODEL_SMARTSDR_H
...
RIG_MODEL_XK852 = _Hamlib.RIG_MODEL_XK852
...
RIG_MODEL_CODAN_2110 = _Hamlib.RIG_MODEL_CODAN_2110
...
RIG_MODEL_MICOM2 = _Hamlib.RIG_MODEL_MICOM2
RIG_MODEL_CTX10 = _Hamlib.RIG_MODEL_CTX10
RIG_MODEL_PMR171 = _Hamlib.RIG_MODEL_PMR171
RIG_MODEL_Q900 = _Hamlib.RIG_MODEL_Q900
...
RIG_ELIMIT = _Hamlib.RIG_ELIMIT
RIG_EACCESS = _Hamlib.RIG_EACCESS
...
RIG_CLIENT_UNKNOWN = _Hamlib.RIG_CLIENT_UNKNOWN
RIG_CLIENT_WSJTX = _Hamlib.RIG_CLIENT_WSJTX
RIG_CLIENT_GPREDICT = _Hamlib.RIG_CLIENT_GPREDICT
...
class value_t(object):
    ...
    u = property(_Hamlib.value_t_u_get, _Hamlib.value_t_u_set)
...
RIG_PARM_AFIF_LAN = _Hamlib.RIG_PARM_AFIF_LAN
RIG_PARM_AFIF_WLAN = _Hamlib.RIG_PARM_AFIF_WLAN
RIG_PARM_AFIF_ACC = _Hamlib.RIG_PARM_AFIF_ACC
...
RIG_KEYERTYPE_UNKNOWN = _Hamlib.RIG_KEYERTYPE_UNKNOWN
...
RIG_MODE_USBD1 = _Hamlib.RIG_MODE_USBD1
RIG_MODE_USBD2 = _Hamlib.RIG_MODE_USBD2
RIG_MODE_USBD3 = _Hamlib.RIG_MODE_USBD3
RIG_MODE_LSBD1 = _Hamlib.RIG_MODE_LSBD1
RIG_MODE_LSBD2 = _Hamlib.RIG_MODE_LSBD2
RIG_MODE_LSBD3 = _Hamlib.RIG_MODE_LSBD3
RIG_MODE_WFMS = _Hamlib.RIG_MODE_WFMS
...
class channel(object):
    ...
    tag = property(_Hamlib.channel_tag_get, _Hamlib.channel_tag_set)
...
class channel_cap(object):
    ...
    tag = property(_Hamlib.channel_cap_tag_get, _Hamlib.channel_cap_tag_set)
...
RIG_MTYPE_SPLIT = _Hamlib.RIG_MTYPE_SPLIT
...
class deferred_config_item(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    nextt = property(_Hamlib.deferred_config_item_nextt_get, _Hamlib.deferred_config_item_nextt_set)
    token = property(_Hamlib.deferred_config_item_token_get, _Hamlib.deferred_config_item_token_set)
    value = property(_Hamlib.deferred_config_item_value_get, _Hamlib.deferred_config_item_value_set)

    def __init__(self):
        _Hamlib.deferred_config_item_swiginit(self, _Hamlib.new_deferred_config_item())
    __swig_destroy__ = _Hamlib.delete_deferred_config_item

# Register deferred_config_item in _Hamlib:
_Hamlib.deferred_config_item_swigregister(deferred_config_item)
class deferred_config_header(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    firstt = property(_Hamlib.deferred_config_header_firstt_get, _Hamlib.deferred_config_header_firstt_set)
    lastt = property(_Hamlib.deferred_config_header_lastt_get, _Hamlib.deferred_config_header_lastt_set)

    def __init__(self):
        _Hamlib.deferred_config_header_swiginit(self, _Hamlib.new_deferred_config_header())
    __swig_destroy__ = _Hamlib.delete_deferred_config_header

# Register deferred_config_header in _Hamlib:
_Hamlib.deferred_config_header_swigregister(deferred_config_header)
...
class rig_caps(object):
    ...
    rig_cleanup = property(_Hamlib.rig_caps_rig_cleanup_get, _Hamlib.rig_caps_rig_cleanup_set)
    rig_open = property(_Hamlib.rig_caps_rig_open_get, _Hamlib.rig_caps_rig_open_set)
    rig_close = property(_Hamlib.rig_caps_rig_close_get, _Hamlib.rig_caps_rig_close_set)
    ...
    stop_voice_mem = property(_Hamlib.rig_caps_stop_voice_mem_get, _Hamlib.rig_caps_stop_voice_mem_set)
    ...
    rig_get_vfo_info = property(_Hamlib.rig_caps_rig_get_vfo_info_get, _Hamlib.rig_caps_rig_get_vfo_info_set)
    ...
    timeout_retry = property(_Hamlib.rig_caps_timeout_retry_get, _Hamlib.rig_caps_timeout_retry_set)
    morse_qsize = property(_Hamlib.rig_caps_morse_qsize_get, _Hamlib.rig_caps_morse_qsize_set)
...
RIG_PTRX_STATE = _Hamlib.RIG_PTRX_STATE
RIG_PTRX_AMPSTATE = _Hamlib.RIG_PTRX_AMPSTATE
RIG_PTRX_ROTSTATE = _Hamlib.RIG_PTRX_ROTSTATE
...
class multicast_s(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    multicast_running = property(_Hamlib.multicast_s_multicast_running_get, _Hamlib.multicast_s_multicast_running_set)
    sock = property(_Hamlib.multicast_s_sock_get, _Hamlib.multicast_s_sock_set)
    seqnumber = property(_Hamlib.multicast_s_seqnumber_get, _Hamlib.multicast_s_seqnumber_set)
    runflag = property(_Hamlib.multicast_s_runflag_get, _Hamlib.multicast_s_runflag_set)
    threadid = property(_Hamlib.multicast_s_threadid_get, _Hamlib.multicast_s_threadid_set)
    mutex = property(_Hamlib.multicast_s_mutex_get, _Hamlib.multicast_s_mutex_set)
    mutex_initialized = property(_Hamlib.multicast_s_mutex_initialized_get, _Hamlib.multicast_s_mutex_initialized_set)
    dest_addr = property(_Hamlib.multicast_s_dest_addr_get, _Hamlib.multicast_s_dest_addr_set)
    port = property(_Hamlib.multicast_s_port_get, _Hamlib.multicast_s_port_set)

    def __init__(self):
        _Hamlib.multicast_s_swiginit(self, _Hamlib.new_multicast_s())
    __swig_destroy__ = _Hamlib.delete_multicast_s

# Register multicast_s in _Hamlib:
_Hamlib.multicast_s_swigregister(multicast_s)
...
class rig_state(object):
    ...
    tuner_control_pathname = property(_Hamlib.rig_state_tuner_control_pathname_get, _Hamlib.rig_state_tuner_control_pathname_set)
    client_version = property(_Hamlib.rig_state_client_version_get, _Hamlib.rig_state_client_version_set)
    offset_vfoa = property(_Hamlib.rig_state_offset_vfoa_get, _Hamlib.rig_state_offset_vfoa_set)
    offset_vfob = property(_Hamlib.rig_state_offset_vfob_get, _Hamlib.rig_state_offset_vfob_set)
    multicast = property(_Hamlib.rig_state_multicast_get, _Hamlib.rig_state_multicast_set)
    rig_model = property(_Hamlib.rig_state_rig_model_get, _Hamlib.rig_state_rig_model_set)
    model_name = property(_Hamlib.rig_state_model_name_get, _Hamlib.rig_state_model_name_set)
    mfg_name = property(_Hamlib.rig_state_mfg_name_get, _Hamlib.rig_state_mfg_name_set)
    version = property(_Hamlib.rig_state_version_get, _Hamlib.rig_state_version_set)
    copyright = property(_Hamlib.rig_state_copyright_get, _Hamlib.rig_state_copyright_set)
    status = property(_Hamlib.rig_state_status_get, _Hamlib.rig_state_status_set)
    rig_type = property(_Hamlib.rig_state_rig_type_get, _Hamlib.rig_state_rig_type_set)
    ptt_type = property(_Hamlib.rig_state_ptt_type_get, _Hamlib.rig_state_ptt_type_set)
    dcd_type = property(_Hamlib.rig_state_dcd_type_get, _Hamlib.rig_state_dcd_type_set)
    port_type = property(_Hamlib.rig_state_port_type_get, _Hamlib.rig_state_port_type_set)
    serial_rate_min = property(_Hamlib.rig_state_serial_rate_min_get, _Hamlib.rig_state_serial_rate_min_set)
    serial_rate_max = property(_Hamlib.rig_state_serial_rate_max_get, _Hamlib.rig_state_serial_rate_max_set)
    serial_data_bits = property(_Hamlib.rig_state_serial_data_bits_get, _Hamlib.rig_state_serial_data_bits_set)
    serial_stop_bits = property(_Hamlib.rig_state_serial_stop_bits_get, _Hamlib.rig_state_serial_stop_bits_set)
    serial_parity = property(_Hamlib.rig_state_serial_parity_get, _Hamlib.rig_state_serial_parity_set)
    serial_handshake = property(_Hamlib.rig_state_serial_handshake_get, _Hamlib.rig_state_serial_handshake_set)
    write_delay = property(_Hamlib.rig_state_write_delay_get, _Hamlib.rig_state_write_delay_set)
    post_write_delay = property(_Hamlib.rig_state_post_write_delay_get, _Hamlib.rig_state_post_write_delay_set)
    timeout = property(_Hamlib.rig_state_timeout_get, _Hamlib.rig_state_timeout_set)
    retry = property(_Hamlib.rig_state_retry_get, _Hamlib.rig_state_retry_set)
    targetable_vfo = property(_Hamlib.rig_state_targetable_vfo_get, _Hamlib.rig_state_targetable_vfo_set)
    async_data_supported = property(_Hamlib.rig_state_async_data_supported_get, _Hamlib.rig_state_async_data_supported_set)
    agc_level_count = property(_Hamlib.rig_state_agc_level_count_get, _Hamlib.rig_state_agc_level_count_set)
    agc_levels = property(_Hamlib.rig_state_agc_levels_get, _Hamlib.rig_state_agc_levels_set)
    ctcss_list = property(_Hamlib.rig_state_ctcss_list_get, _Hamlib.rig_state_ctcss_list_set)
    dcs_list = property(_Hamlib.rig_state_dcs_list_get, _Hamlib.rig_state_dcs_list_set)
    vfo_ops = property(_Hamlib.rig_state_vfo_ops_get, _Hamlib.rig_state_vfo_ops_set)
    scan_ops = property(_Hamlib.rig_state_scan_ops_get, _Hamlib.rig_state_scan_ops_set)
    transceive = property(_Hamlib.rig_state_transceive_get, _Hamlib.rig_state_transceive_set)
    bank_qty = property(_Hamlib.rig_state_bank_qty_get, _Hamlib.rig_state_bank_qty_set)
    chan_desc_sz = property(_Hamlib.rig_state_chan_desc_sz_get, _Hamlib.rig_state_chan_desc_sz_set)
    rx_range_list1 = property(_Hamlib.rig_state_rx_range_list1_get, _Hamlib.rig_state_rx_range_list1_set)
    tx_range_list1 = property(_Hamlib.rig_state_tx_range_list1_get, _Hamlib.rig_state_tx_range_list1_set)
    rx_range_list2 = property(_Hamlib.rig_state_rx_range_list2_get, _Hamlib.rig_state_rx_range_list2_set)
    tx_range_list2 = property(_Hamlib.rig_state_tx_range_list2_get, _Hamlib.rig_state_tx_range_list2_set)
    rx_range_list3 = property(_Hamlib.rig_state_rx_range_list3_get, _Hamlib.rig_state_rx_range_list3_set)
    tx_range_list3 = property(_Hamlib.rig_state_tx_range_list3_get, _Hamlib.rig_state_tx_range_list3_set)
    rx_range_list4 = property(_Hamlib.rig_state_rx_range_list4_get, _Hamlib.rig_state_rx_range_list4_set)
    tx_range_list4 = property(_Hamlib.rig_state_tx_range_list4_get, _Hamlib.rig_state_tx_range_list4_set)
    rx_range_list5 = property(_Hamlib.rig_state_rx_range_list5_get, _Hamlib.rig_state_rx_range_list5_set)
    tx_range_list5 = property(_Hamlib.rig_state_tx_range_list5_get, _Hamlib.rig_state_tx_range_list5_set)
    spectrum_scopes = property(_Hamlib.rig_state_spectrum_scopes_get, _Hamlib.rig_state_spectrum_scopes_set)
    spectrum_modes = property(_Hamlib.rig_state_spectrum_modes_get, _Hamlib.rig_state_spectrum_modes_set)
    spectrum_spans = property(_Hamlib.rig_state_spectrum_spans_get, _Hamlib.rig_state_spectrum_spans_set)
    spectrum_avg_modes = property(_Hamlib.rig_state_spectrum_avg_modes_get, _Hamlib.rig_state_spectrum_avg_modes_set)
    spectrum_attenuator = property(_Hamlib.rig_state_spectrum_attenuator_get, _Hamlib.rig_state_spectrum_attenuator_set)
    morse_data_handler_thread_run = property(_Hamlib.rig_state_morse_data_handler_thread_run_get, _Hamlib.rig_state_morse_data_handler_thread_run_set)
    morse_data_handler_priv_data = property(_Hamlib.rig_state_morse_data_handler_priv_data_get, _Hamlib.rig_state_morse_data_handler_priv_data_set)
    fifo_morse = property(_Hamlib.rig_state_fifo_morse_get, _Hamlib.rig_state_fifo_morse_set)
    doppler = property(_Hamlib.rig_state_doppler_get, _Hamlib.rig_state_doppler_set)
    multicast_data_addr = property(_Hamlib.rig_state_multicast_data_addr_get, _Hamlib.rig_state_multicast_data_addr_set)
    multicast_data_port = property(_Hamlib.rig_state_multicast_data_port_get, _Hamlib.rig_state_multicast_data_port_set)
    multicast_cmd_addr = property(_Hamlib.rig_state_multicast_cmd_addr_get, _Hamlib.rig_state_multicast_cmd_addr_set)
    multicast_cmd_port = property(_Hamlib.rig_state_multicast_cmd_port_get, _Hamlib.rig_state_multicast_cmd_port_set)
    multicast_receiver_run = property(_Hamlib.rig_state_multicast_receiver_run_get, _Hamlib.rig_state_multicast_receiver_run_set)
    multicast_receiver_priv_data = property(_Hamlib.rig_state_multicast_receiver_priv_data_get, _Hamlib.rig_state_multicast_receiver_priv_data_set)
    comm_status = property(_Hamlib.rig_state_comm_status_get, _Hamlib.rig_state_comm_status_set)
    device_id = property(_Hamlib.rig_state_device_id_get, _Hamlib.rig_state_device_id_set)
    dual_watch = property(_Hamlib.rig_state_dual_watch_get, _Hamlib.rig_state_dual_watch_set)
    post_ptt_delay = property(_Hamlib.rig_state_post_ptt_delay_get, _Hamlib.rig_state_post_ptt_delay_set)
    freq_event_elapsed = property(_Hamlib.rig_state_freq_event_elapsed_get, _Hamlib.rig_state_freq_event_elapsed_set)
    freq_skip = property(_Hamlib.rig_state_freq_skip_get, _Hamlib.rig_state_freq_skip_set)
    client = property(_Hamlib.rig_state_client_get, _Hamlib.rig_state_client_set)
    api_mutex = property(_Hamlib.rig_state_api_mutex_get, _Hamlib.rig_state_api_mutex_set)
...
class Rig(object):
    ...
    def set_dcs_sql(self, vfo, _tone_t):
        return _Hamlib.Rig_set_dcs_sql(self, vfo, _tone_t)
    ...
    def set_ext_parm(self, _hamlib_token_t_1, _value_t_2):
        return _Hamlib.Rig_set_ext_parm(self, _hamlib_token_t_1, _value_t_2)
    ...
    def set_freq_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_freq_callback(self, cb, arg)

    def set_mode_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_mode_callback(self, cb, arg)

    def set_vfo_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_vfo_callback(self, cb, arg)

    def set_ptt_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_ptt_callback(self, cb, arg)

    def set_dcd_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_dcd_callback(self, cb, arg)

    def set_pltune_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_pltune_callback(self, cb, arg)

    def set_spectrum_callback(self, cb, arg=None):
        return _Hamlib.Rig_set_spectrum_callback(self, cb, arg)
    ...
    def send_raw(self, send_obj, term_obj=None):
        return _Hamlib.Rig_send_raw(self, send_obj, term_obj)
...
ROT_MOVE_UP_LEFT = _Hamlib.ROT_MOVE_UP_LEFT
ROT_MOVE_UP_CCW = _Hamlib.ROT_MOVE_UP_CCW
ROT_MOVE_UP_RIGHT = _Hamlib.ROT_MOVE_UP_RIGHT
ROT_MOVE_UP_CW = _Hamlib.ROT_MOVE_UP_CW
ROT_MOVE_DOWN_LEFT = _Hamlib.ROT_MOVE_DOWN_LEFT
ROT_MOVE_DOWN_CCW = _Hamlib.ROT_MOVE_DOWN_CCW
ROT_MOVE_DOWN_RIGHT = _Hamlib.ROT_MOVE_DOWN_RIGHT
ROT_MOVE_DOWN_CW = _Hamlib.ROT_MOVE_DOWN_CW
...
class rot_caps(object):
    ...
    rot_cleanup = property(_Hamlib.rot_caps_rot_cleanup_get, _Hamlib.rot_caps_rot_cleanup_set)
    rot_open = property(_Hamlib.rot_caps_rot_open_get, _Hamlib.rot_caps_rot_open_set)
    rot_close = property(_Hamlib.rot_caps_rot_close_get, _Hamlib.rot_caps_rot_close_set)
...
ROT_MODEL_PSTROTATOR = _Hamlib.ROT_MODEL_PSTROTATOR
ROT_MODEL_SATROTCTL = _Hamlib.ROT_MODEL_SATROTCTL
...
ROT_MODEL_AF6SA_WRC = _Hamlib.ROT_MODEL_AF6SA_WRC
...
ROT_MODEL_SKYWATCHER = _Hamlib.ROT_MODEL_SKYWATCHER
class rot_state(object):
    ...
    pstrotator_handler_priv_data = property(_Hamlib.rot_state_pstrotator_handler_priv_data_get, _Hamlib.rot_state_pstrotator_handler_priv_data_set)
    config_queue = property(_Hamlib.rot_state_config_queue_get, _Hamlib.rot_state_config_queue_set)
...
class Rot(object):
    ...
    def set_ext_func(self, _hamlib_token_t_1, _int_2):
        return _Hamlib.Rot_set_ext_func(self, _hamlib_token_t_1, _int_2)

    def set_ext_level(self, _hamlib_token_t_1, _value_t_2):
        return _Hamlib.Rot_set_ext_level(self, _hamlib_token_t_1, _value_t_2)

    def set_ext_parm(self, _hamlib_token_t_1, _value_t_2):
        return _Hamlib.Rot_set_ext_parm(self, _hamlib_token_t_1, _value_t_2)

    def set_func(self, _setting_t_1, _int_2):
        return _Hamlib.Rot_set_func(self, _setting_t_1, _int_2)

    def set_level(self, _setting_t_1, _value_t_2):
        return _Hamlib.Rot_set_level(self, _setting_t_1, _value_t_2)

    def set_parm(self, _setting_t_1, _value_t_2):
        return _Hamlib.Rot_set_parm(self, _setting_t_1, _value_t_2)
    ...
    def get_func(self, token):
        return _Hamlib.Rot_get_func(self, token)

    def get_ext_func(self, token):
        return _Hamlib.Rot_get_ext_func(self, token)

    def get_level(self, token):
        return _Hamlib.Rot_get_level(self, token)

    def get_ext_level(self, token):
        return _Hamlib.Rot_get_ext_level(self, token)

    def get_parm(self, token):
        return _Hamlib.Rot_get_parm(self, token)

    def get_ext_parm(self, token):
        return _Hamlib.Rot_get_ext_parm(self, token)
...
AMP_MODEL_NONE = _Hamlib.AMP_MODEL_NONE
AMP_MODEL_DUMMY = _Hamlib.AMP_MODEL_DUMMY
AMP_MODEL_NETAMPCTL = _Hamlib.AMP_MODEL_NETAMPCTL
AMP_MODEL_ELECRAFT_KPA1500 = _Hamlib.AMP_MODEL_ELECRAFT_KPA1500
AMP_MODEL_GEMINI_DX1200 = _Hamlib.AMP_MODEL_GEMINI_DX1200
AMP_MODEL_EXPERT_FA = _Hamlib.AMP_MODEL_EXPERT_FA
NETAMPCTL_RET = _Hamlib.NETAMPCTL_RET
AMP_RESET_MEM = _Hamlib.AMP_RESET_MEM
AMP_RESET_FAULT = _Hamlib.AMP_RESET_FAULT
AMP_RESET_AMP = _Hamlib.AMP_RESET_AMP
AMP_FLAG_1 = _Hamlib.AMP_FLAG_1
AMP_FLAG_2 = _Hamlib.AMP_FLAG_2
AMP_TYPE_OTHER = _Hamlib.AMP_TYPE_OTHER
AMP_LEVEL_NONE = _Hamlib.AMP_LEVEL_NONE
AMP_LEVEL_SWR = _Hamlib.AMP_LEVEL_SWR
AMP_LEVEL_NH = _Hamlib.AMP_LEVEL_NH
AMP_LEVEL_PF = _Hamlib.AMP_LEVEL_PF
AMP_LEVEL_PWR_INPUT = _Hamlib.AMP_LEVEL_PWR_INPUT
AMP_LEVEL_PWR_FWD = _Hamlib.AMP_LEVEL_PWR_FWD
AMP_LEVEL_PWR_REFLECTED = _Hamlib.AMP_LEVEL_PWR_REFLECTED
AMP_LEVEL_PWR_PEAK = _Hamlib.AMP_LEVEL_PWR_PEAK
AMP_LEVEL_FAULT = _Hamlib.AMP_LEVEL_FAULT
AMP_LEVEL_PWR = _Hamlib.AMP_LEVEL_PWR
class amp_caps(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    amp_model = property(_Hamlib.amp_caps_amp_model_get, _Hamlib.amp_caps_amp_model_set)
    model_name = property(_Hamlib.amp_caps_model_name_get)
    mfg_name = property(_Hamlib.amp_caps_mfg_name_get)
    version = property(_Hamlib.amp_caps_version_get)
    copyright = property(_Hamlib.amp_caps_copyright_get)
    status = property(_Hamlib.amp_caps_status_get, _Hamlib.amp_caps_status_set)
    amp_type = property(_Hamlib.amp_caps_amp_type_get, _Hamlib.amp_caps_amp_type_set)
    port_type = property(_Hamlib.amp_caps_port_type_get, _Hamlib.amp_caps_port_type_set)
    serial_rate_min = property(_Hamlib.amp_caps_serial_rate_min_get, _Hamlib.amp_caps_serial_rate_min_set)
    serial_rate_max = property(_Hamlib.amp_caps_serial_rate_max_get, _Hamlib.amp_caps_serial_rate_max_set)
    serial_data_bits = property(_Hamlib.amp_caps_serial_data_bits_get, _Hamlib.amp_caps_serial_data_bits_set)
    serial_stop_bits = property(_Hamlib.amp_caps_serial_stop_bits_get, _Hamlib.amp_caps_serial_stop_bits_set)
    serial_parity = property(_Hamlib.amp_caps_serial_parity_get, _Hamlib.amp_caps_serial_parity_set)
    serial_handshake = property(_Hamlib.amp_caps_serial_handshake_get, _Hamlib.amp_caps_serial_handshake_set)
    write_delay = property(_Hamlib.amp_caps_write_delay_get, _Hamlib.amp_caps_write_delay_set)
    post_write_delay = property(_Hamlib.amp_caps_post_write_delay_get, _Hamlib.amp_caps_post_write_delay_set)
    timeout = property(_Hamlib.amp_caps_timeout_get, _Hamlib.amp_caps_timeout_set)
    retry = property(_Hamlib.amp_caps_retry_get, _Hamlib.amp_caps_retry_set)
    cfgparams = property(_Hamlib.amp_caps_cfgparams_get, _Hamlib.amp_caps_cfgparams_set)
    priv = property(_Hamlib.amp_caps_priv_get, _Hamlib.amp_caps_priv_set)
    amp_model_macro_name = property(_Hamlib.amp_caps_amp_model_macro_name_get, _Hamlib.amp_caps_amp_model_macro_name_set)
    has_get_level = property(_Hamlib.amp_caps_has_get_level_get, _Hamlib.amp_caps_has_get_level_set)
    has_set_level = property(_Hamlib.amp_caps_has_set_level_get, _Hamlib.amp_caps_has_set_level_set)
    level_gran = property(_Hamlib.amp_caps_level_gran_get, _Hamlib.amp_caps_level_gran_set)
    parm_gran = property(_Hamlib.amp_caps_parm_gran_get, _Hamlib.amp_caps_parm_gran_set)
    amp_init = property(_Hamlib.amp_caps_amp_init_get, _Hamlib.amp_caps_amp_init_set)
    amp_cleanup = property(_Hamlib.amp_caps_amp_cleanup_get, _Hamlib.amp_caps_amp_cleanup_set)
    amp_open = property(_Hamlib.amp_caps_amp_open_get, _Hamlib.amp_caps_amp_open_set)
    amp_close = property(_Hamlib.amp_caps_amp_close_get, _Hamlib.amp_caps_amp_close_set)
    set_freq = property(_Hamlib.amp_caps_set_freq_get, _Hamlib.amp_caps_set_freq_set)
    get_freq = property(_Hamlib.amp_caps_get_freq_get, _Hamlib.amp_caps_get_freq_set)
    set_conf = property(_Hamlib.amp_caps_set_conf_get, _Hamlib.amp_caps_set_conf_set)
    get_conf2 = property(_Hamlib.amp_caps_get_conf2_get, _Hamlib.amp_caps_get_conf2_set)
    get_conf = property(_Hamlib.amp_caps_get_conf_get, _Hamlib.amp_caps_get_conf_set)
    reset = property(_Hamlib.amp_caps_reset_get, _Hamlib.amp_caps_reset_set)
    get_level = property(_Hamlib.amp_caps_get_level_get, _Hamlib.amp_caps_get_level_set)
    set_level = property(_Hamlib.amp_caps_set_level_get, _Hamlib.amp_caps_set_level_set)
    get_ext_level = property(_Hamlib.amp_caps_get_ext_level_get, _Hamlib.amp_caps_get_ext_level_set)
    set_ext_level = property(_Hamlib.amp_caps_set_ext_level_get, _Hamlib.amp_caps_set_ext_level_set)
    set_powerstat = property(_Hamlib.amp_caps_set_powerstat_get, _Hamlib.amp_caps_set_powerstat_set)
    get_powerstat = property(_Hamlib.amp_caps_get_powerstat_get, _Hamlib.amp_caps_get_powerstat_set)
    get_info = property(_Hamlib.amp_caps_get_info_get, _Hamlib.amp_caps_get_info_set)
    levels = property(_Hamlib.amp_caps_levels_get, _Hamlib.amp_caps_levels_set)
    ext_levels = property(_Hamlib.amp_caps_ext_levels_get, _Hamlib.amp_caps_ext_levels_set)
    extlevels = property(_Hamlib.amp_caps_extlevels_get, _Hamlib.amp_caps_extlevels_set)
    extparms = property(_Hamlib.amp_caps_extparms_get, _Hamlib.amp_caps_extparms_set)

    def __init__(self):
        _Hamlib.amp_caps_swiginit(self, _Hamlib.new_amp_caps())
    __swig_destroy__ = _Hamlib.delete_amp_caps

# Register amp_caps in _Hamlib:
_Hamlib.amp_caps_swigregister(amp_caps)
class amp_state(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    comm_state = property(_Hamlib.amp_state_comm_state_get, _Hamlib.amp_state_comm_state_set)
    priv = property(_Hamlib.amp_state_priv_get, _Hamlib.amp_state_priv_set)
    obj = property(_Hamlib.amp_state_obj_get, _Hamlib.amp_state_obj_set)
    has_get_level = property(_Hamlib.amp_state_has_get_level_get, _Hamlib.amp_state_has_get_level_set)
    has_set_level = property(_Hamlib.amp_state_has_set_level_get, _Hamlib.amp_state_has_set_level_set)
    level_gran = property(_Hamlib.amp_state_level_gran_get, _Hamlib.amp_state_level_gran_set)
    parm_gran = property(_Hamlib.amp_state_parm_gran_get, _Hamlib.amp_state_parm_gran_set)
    ampport = property(_Hamlib.amp_state_ampport_get, _Hamlib.amp_state_ampport_set)

    def __init__(self):
        _Hamlib.amp_state_swiginit(self, _Hamlib.new_amp_state())
    __swig_destroy__ = _Hamlib.delete_amp_state

# Register amp_state in _Hamlib:
_Hamlib.amp_state_swigregister(amp_state)
class Amp(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def get_freq(self):
        return _Hamlib.Amp_get_freq(self)

    def get_info(self):
        return _Hamlib.Amp_get_info(self)

    def get_powerstat(self):
        return _Hamlib.Amp_get_powerstat(self)

    def get_level(self, level):
        return _Hamlib.Amp_get_level(self, level)
